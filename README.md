...
![已核查](https://img.shields.io/badge/%E5%B7%B2%E6%A0%B8%E6%9F%A5-54%2F102-brightgreen) ![通过来源核验](https://img.shields.io/badge/%E9%80%9A%E8%BF%87%E6%9D%A5%E6%BA%90%E6%A0%B8%E9%AA%8C-100%25-brightgreen) ![锚定](https://img.shields.io/badge/%E9%94%9A%E5%AE%9A-%E5%A4%9A%E7%89%88%E6%9C%AC-orange) ![排队复核](https://img.shields.io/badge/%E6%8E%92%E9%98%9F%E5%A4%8D%E6%A0%B8-48-yellow)
...
当前收录 **227** 个命令,其中 **54** 个已完成 LLM 二阶段交叉核查(对照 docs.claude.com 官方源),通过率 **100%**。
...
| `/clear` | 使用空上下文开始新对话并保留前一个 | ⏳ 排队复核 | v2.1.179 | [查看](https://claude.aiso.cool/commands/slash-clear) |
...
| `/model` | 设置当前会话使用的AI模型 | ⏳ 排队复核 | v2.1.179 | [查看](https://claude.aiso.cool/commands/slash-model) |
...
| `/recap` | 生成当前会话的一行摘要 | ⏳ 排队复核 | v2.1.179 | [查看](https://claude.aiso.cool/commands/slash-recap) |
...
| `/review` | 在本地会话中查看和审查 pull request | ⏳ 排队复核 | v2.1.179 | [查看](https://claude.aiso.cool/commands/slash-review) |
| `/rewind` | 将对话和代码倒回到之前的点 | ⏳ 排队复核 | v2.1.179 | [查看](https://claude.aiso.cool/commands/slash-rewind) |
| `/sandbox` | 切换沙箱模式提高安全性 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-sandbox) |
| `/schedule` | 创建更新或运行在云基础设施执行的例程 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-schedule) |
| `/scroll-speed` | 交互式调整鼠标滚轮滚动速度 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-scroll-speed) |
| `/security-review` | 分析待处理变更的安全漏洞风险 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-security-review) |
| `/settings` | — | — | — | [查看](https://claude.aiso.cool/commands/slash-settings) |
| `/setup-bedrock` | 配置 Amazon Bedrock 认证和模型 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-setup-bedrock) |
| `/setup-vertex` | 配置 Google Vertex AI 认证和模型 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-setup-vertex) |
| `/simplify` | — | — | — | [查看](https://claude.aiso.cool/commands/slash-simplify) |
| `/skills` | 列出可用 skills 和隐藏不需要的 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-skills) |
| `/stats` | 打开统计标签显示使用情况 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-stats) |
| `/status` | 打开设置界面显示版本模型和连接 | ⏳ 排队复核 | v2.1.178 | [查看](https://claude.aiso.cool/commands/slash-status) |
...
<sub>Last generated 2026-06-17 · Aligned to multiple versions · Powered by [claude.aiso.cool](https://claude.aiso.cool)</sub>

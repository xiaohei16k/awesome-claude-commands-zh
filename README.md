...
| `/copy` | 将最后的助手响应复制到剪贴板 | 🟠 重大 | v2.1.183 | [查看](https://claude.aiso.cool/commands/slash-copy) |
...
| `/desktop` | 在 Claude Code Desktop 应用中继续会话 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/slash-desktop) |
| `/diff` | 打开交互式 diff 查看器显示未提交更改 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/slash-diff) |
| `/doctor` | 诊断并验证 Claude Code 的安装和设置 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/slash-doctor) |
...
| `/remote-env` | 配置网络会话的默认远程环境 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/slash-remote-env) |
...
| `/tasks` | 列出和管理后台任务及相关信息 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/slash-tasks) |
...
| `/theme` | 更改终端配色主题和样式 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/slash-theme) |
...
<sub>Last generated 2026-06-19 · Aligned to multiple versions · Powered by [claude.aiso.cool](https://claude.aiso.cool)</sub>

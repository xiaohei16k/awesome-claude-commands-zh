...
| 命令 | 简介 | 核查结论 | 锚定版本 | 详情 |
| --- | --- | --- | --- | --- |
| `/add-dir` | 为当前会话添加工作目录以用于文件访问 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/add-dir) |
| `/advisor` | — | — | — | [查看](https://claude.aiso.cool/commands/advisor) |
| `/agents` | 管理代理的配置和设置选项 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/agents) |
| `/approved-tools` | — | — | — | [查看](https://claude.aiso.cool/commands/approved-tools) |
| `/autofix-pr` | 启动远程会话自动修复 PR 中的 CI 失败 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/autofix-pr) |
| `/background` | 将当前会话后台运行并释放当前终端 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/background) |
| `/batch` | 并行编排大规模代码库变更和提交 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/batch) |
| `/bg` | — | — | — | [查看](https://claude.aiso.cool/commands/bg) |
| `/branch` | 在当前位置创建对话分支以保留原始会话 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/branch) |
| `/btw` | 提出快速旁问而不添加到对话 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/btw) |
| `/buddy` | — | — | — | [查看](https://claude.aiso.cool/commands/buddy) |
| `/bug` | — | — | — | [查看](https://claude.aiso.cool/commands/bug) |
| `/cd` | — | — | — | [查看](https://claude.aiso.cool/commands/cd) |
| `/chrome` | 配置 Claude 在 Chrome 浏览器中的设置 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/chrome) |
| `/claude-api` | 加载项目语言的 Claude API 参考和代理文档 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/claude-api) |
| `/clear` | 使用空上下文开始新对话并保留前一个 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/clear) |
| `/code-review` | 检查当前 diff 中的代码正确性缺陷并报告 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/code-review) |
| `/color` | 为当前会话设置提示栏的颜色主题 | 🟢 通过 | v2.1.178 | [查看](https://claude.aiso.cool/commands/color) |
| `/commit-push-pr` | — | — | — | [查看](https://claude.aiso.cool/commands/commit-push-pr) |
| `/compact` | 通过汇总对话内容来释放上下文空间 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/compact) |
| `/config` | 打开设置界面调整主题、模型等偏好 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/config) |
| `/context` | 可视化当前上下文使用情况和优化建议 | 🟠 重大 | v2.1.178 | [查看](https://claude.aiso.cool/commands/context) |
| `/copy` | 将最后的助手响应复制到剪贴板 | 🟠 重大 | v2.1.183 | [查看](https://claude.aiso.cool/commands/copy) |
| `/cost` | 显示使用成本和计费统计信息 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/cost) |
| `/debug` | 启用调试日志并诊断排查会话问题 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/debug) |
| `/desktop` | 在 Claude Code Desktop 应用中继续会话 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/desktop) |
| `/diff` | 打开交互式 diff 查看器显示未提交更改 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/diff) |
| `/doctor` | 诊断并验证 Claude Code 的安装和设置 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/doctor) |
| `/effort` | 设置模型工作难度级别从低到最高 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/effort) |
| `/env` | — | — | — | [查看](https://claude.aiso.cool/commands/env) |
| `/exit` | 退出 CLI 或从后台会话中分离 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/exit) |
| `/export` | 将当前对话导出为纯文本格式或保存文件 | 🟢 通过 | v2.1.178 | [查看](https://claude.aiso.cool/commands/export) |
| `/extra-usage` | — | — | — | [查看](https://claude.aiso.cool/commands/extra-usage) |
| `/fast` | 切换快速模式的开启或关闭状态 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/fast) |
| `/feedback` | 提交反馈、报告错误或分享对话 | 🟠 重大 | v2.1.181 | [查看](https://claude.aiso.cool/commands/feedback) |
| `/focus` | 切换焦点视图仅显示最后提示和工具摘要 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/focus) |
| `/fork` | — | — | — | [查看](https://claude.aiso.cool/commands/fork) |
| `/goal` | 设置目标使Claude持续工作直到条件满足 | 🟢 通过 | v2.1.178 | [查看](https://claude.aiso.cool/commands/goal) |
| `/heapdump` | 写入堆快照和内存分解以诊断高内存使用 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/heapdump) |
| `/help` | 显示帮助信息和可用的所有命令 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/help) |
| `/hooks` | 查看和管理工具事件的Hook配置 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/hooks) |
| `/ide` | 管理IDE集成并显示集成状态 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/ide) |
| `/init` | 使用CLAUDE.md指南初始化项目 | 🟢 通过 | v2.1.178 | [查看](https://claude.aiso.cool/commands/init) |
| `/insights` | 生成分析Claude Code会话的报告 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/insights) |
| `/install-github-app` | 为仓库设置Claude GitHub Actions应用 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/install-github-app) |
...
| `/login` | 登录Anthropic账户并验证身份 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/login) |
| `/logout` | 登出Anthropic账户并清除会话 | 🟢 通过 | v2.1.179 | [查看](https://claude.aiso.cool/commands/logout) |
| `/loop` | 重复运行提示直到会话关闭 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/loop) |
| `/mcp` | 管理MCP服务器连接和OAuth认证 | 🟡 轻微 | v2.1.178 | [查看](https://claude.aiso.cool/commands/mcp) |
...
| `/model` | 设置当前会话使用的AI模型 | 🟢 通过 | v2.1.179 | [查看](https://claude.aiso.cool/commands/model) |
| `/output-style` | — | — | — | [查看](https://claude.aiso.cool/commands/output-style) |
| `/permissions` | 管理工具权限的允许、询问和拒绝规则 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/permissions) |
| `/plan` | 直接从提示进入计划模式执行任务 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/plan) |
| `/plugin` | 管理Claude Code的插件配置 | 🟢 通过 | v2.1.179 | [查看](https://claude.aiso.cool/commands/plugin) |
...
| `/poll` | — | — | — | [查看](https://claude.aiso.cool/commands/poll) |
| `/powerup` | 通过快速交互课程发现Claude Code功能 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/powerup) |
| `/proactive` | — | — | — | [查看](https://claude.aiso.cool/commands/proactive) |
| `/recap` | 生成当前会话的一行摘要 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/recap) |
| `/release-notes` | 在交互版本选择器中查看变更日志 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/release-notes) |
| `/reload-plugins` | 重新加载活跃插件应用待处理变更 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/reload-plugins) |
| `/reload-skills` | — | — | — | [查看](https://claude.aiso.cool/commands/reload-skills) |
| `/remote-control` | 使此会话可从 claude.ai 远程控制 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/remote-control) |
| `/remote-env` | 配置网络会话的默认远程环境 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/remote-env) |
| `/rename` | 重命名当前会话并在提示栏显示 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/rename) |
| `/resume` | 通过 ID 或名称恢复会话或打开选择器 | 🟢 通过 | v2.1.179 | [查看](https://claude.aiso.cool/commands/resume) |
| `/review` | 在本地会话中查看和审查 pull request | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/review) |
| `/rewind` | 将对话和代码倒回到之前的点 | 🟢 通过 | v2.1.179 | [查看](https://claude.aiso.cool/commands/rewind) |
| `/sandbox` | 切换沙箱模式提高安全性 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/sandbox) |
| `/schedule` | 创建更新或运行在云基础设施执行的例程 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/schedule) |
| `/scroll-speed` | 交互式调整鼠标滚轮滚动速度 | 🟢 通过 | v2.1.179 | [查看](https://claude.aiso.cool/commands/scroll-speed) |
| `/security-review` | 分析待处理变更的安全漏洞风险 | 🟡 轻微 | v2.1.179 | [查看](https://claude.aiso.cool/commands/security-review) |
...
| `/setup-vertex` | 配置 Google Vertex AI 认证和模型 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/setup-vertex) |
| `/simplify` | — | — | — | [查看](https://claude.aiso.cool/commands/simplify) |
| `/skills` | 列出可用 skills 和隐藏不需要的 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/skills) |
| `/stats` | 打开统计标签显示使用情况 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/stats) |
| `/status` | 打开设置界面显示版本模型和连接 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/status) |
| `/statusline` | 配置 Claude Code 的状态行显示信息 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/statusline) |
| `/t` | — | — | — | [查看](https://claude.aiso.cool/commands/t) |
| `/tasks` | 列出和管理后台任务及相关信息 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/tasks) |
| `/team-onboarding` | 从使用历史生成团队入门指南 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/team-onboarding) |
| `/teleport` | 从网页版Claude Code拉入当前终端 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/teleport) |
| `/terminal-setup` | 配置Shift+Enter等终端快捷键 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/terminal-setup) |
| `/theme` | 更改终端配色主题和样式 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/theme) |
| `/todos` | — | — | — | [查看](https://claude.aiso.cool/commands/todos) |
| `/tui` | 设置终端UI渲染器并重启会话 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/tui) |
...
| `/update` | — | — | — | [查看](https://claude.aiso.cool/commands/update) |
| `/upgrade` | 打开升级页面切换计划等级 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/upgrade) |
| `/usage` | 显示会话成本和订阅使用统计 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/usage) |
| `/usage-credits` | 配置usage credits在限制后继续工作 | 🟡 轻微 | v2.1.181 | [查看](https://claude.aiso.cool/commands/usage-credits) |
| `/voice` | 开启或配置语音听写模式 | 🟡 轻微 | v2.1.183 | [查看](https://claude.aiso.cool/commands/voice) |
| `/web-setup` | 连接GitHub账户以使用网页版功能 | 🟢 通过 | v2.1.181 | [查看](https://claude.aiso.cool/commands/web-setup) |
| `/workflows` | — | — | — | [查看](https://claude.aiso.cool/commands/workflows) |
...
| 命令 | 简介 | 核查结论 | 锚定版本 | 详情 |
| --- | --- | --- | --- | --- |
| `claude agents` | 打开 Agent 视图监控并发送后台会话 | 🟠 重大 | v2.1.183 | [查看](https://claude.aiso.cool/commands/cli-agents) |
...
<sub>Last generated 2026-06-22 · Aligned to multiple versions · Powered by [claude.aiso.cool](https://claude.aiso.cool)</sub>
